...
const StudentTestimonials = () => {
  return (
    <div className="container mx-auto pb-10">
      <h1 className="text-center text-3xl md:text-5xl font-bold my-10 text-logoRed">Student Testimonials</h1>
      <p className="text-center mb-10">Hear from our students about their experiences at EHFCAC.</p>
